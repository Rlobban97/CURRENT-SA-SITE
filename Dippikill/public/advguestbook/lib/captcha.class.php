...
class SimpleCaptcha {
	...
	function SimpleCaptcha() {
		...
		$this->gridSize = 10;
		$this->hasGDSupport = (extension_loaded("gd") && function_exists("imagettftext")) ? true : false;
		if ($this->hasGDSupport == true) {
	...
	function getImageFile($filename, $type="png") {
		...
		switch ($type) {
			case "jpeg":
			case "jpg":
				if ($this->supportedImagesTypes['jpg'] == true) {
			...
			case "png":
				if ($this->supportedImagesTypes['png'] == true) {
			...
			case "gif":
				if ($this->supportedImagesTypes['gif'] == true) {
	...
	function getSupportedImagesTypes() {
		...
		$this->supportedImagesTypes['png'] = (imagetypes() & IMG_PNG) ? true : false;
		$this->supportedImagesTypes['gif'] = (imagetypes() & IMG_GIF) ? true : false;
		$this->supportedImagesTypes['jpg'] = (imagetypes() & IMG_JPG) ? true : false;
		return $this->supportedImagesTypes;
	}
